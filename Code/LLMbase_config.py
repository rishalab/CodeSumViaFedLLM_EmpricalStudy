...
model_id = "codellama/CodeLlama-7b-Instruct-hf" #"NousResearch/Llama-2-7b-hf"
...
bnb_4bit_compute_dtype = "float16" #"float32" #default, however in code actual is taken
...
per_device_train_batch_size = 6 #2#6#16
